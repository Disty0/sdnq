...
- SDNQ supports Hadamard Rotations, SVD Quantization and Lloyd-Max Codebook Quantization on both quantized weights and quantized matmul for inference and training.  
