...
def int8_matmul(input: torch.FloatTensor, weight: torch.Tensor, bias: torch.FloatTensor, scale: torch.FloatTensor, output_shape: torch.Size = None, do_input_reshape: bool = True, do_transpose: bool = False, is_backward_pass: bool = False) -> torch.FloatTensor:
    if is_backward_pass:
